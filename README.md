...
- `pages/map.html` — Thermal Map: Leaflet + permukaan termal kontinu, lapisan Suhu/Kelembapan/Udara, pencarian, lokasi, detail area
- `pages/cool-route.html` — Cool Route: geocoding Nominatim + routing OSRM + estimasi paparan panas dari permukaan termal
